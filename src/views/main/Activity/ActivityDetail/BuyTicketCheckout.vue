  ...
  <div class="row flex-column flex-md-row justify-content-center gap-3 gap-lg-0 mb-4">
    ...
    <div class="col-12 col-lg-6">
      <div class="roundedM bg-primary text-white p-4 mb-4">
        <p class="fs-5 mb-1">5/23 BLACKPINK</p>
        <p class="fs-18">BLACKPINK高雄站演唱會 2023｜BORN PINK</p>
        <div class="d-flex justify-content-between">
          <p class="mb-2">訂單編號 : E01-P000-000-001</p>
          <p class="mb-2">02/16</p>
        </div>
        <div class="d-flex justify-content-between">
          <p class="mb-2">張數</p>
          <p class="mb-2">2張</p>
      ...
      <div class="">
        ...
        <div class="payment-method row justify-content-between">
          <div class="col-6">
            <button type="button" class=" btn btn-outline-primaryB border-primary w-100 d-flex flex-column flex-lg-row justify-content-between">
